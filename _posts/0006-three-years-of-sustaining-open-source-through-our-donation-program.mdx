---
title: Three years of sustaining Open Source through our donation program
slug: three-years-of-sustaining-open-source-through-our-donation-program
draft: true
---
...
We have always supported our engineering department to engage in Open Source projects. As a result employees have built and maintained quite successful Open Source projects like [sangria](https://sangria-graphql.github.io/), [cornichon](http://agourlay.github.io/cornichon/) or [flopflip](https://github.com/tdeekens/flopflip). We have continuously evolved them, adopted them internally while also other companies started using them. In the summer of 2020 however we discussed that we wanted to do more and start to donate to Open Source projects.
...
In 2022 we again had around 20 projects which were suggested to receive a donation but already around 50 votes on them. Resulting in [Prettier](https://prettier.io/), [pytest](https://docs.pytest.org), [ScalaMeta](https://scalameta.org/) and [Logback](https://logback.qos.ch/), [Yarn](https://yarnpkg.com/), [Typelevel Cats](https://typelevel.org/cats/), [K9s](https://k9scli.io/) and [Jest](https://jestjs.io/). We took our lessons in the internal process to handle the donations and everything ran more smoothly than the year before.

By the end of 2022 we already planned for 2023 knowing that the economic circumstances might restrict our ability to make donations. Still we managed to secure the same budget as the years before and plan to donate to eight projects again. By now we donated to [neovim](https://neovim.io/) and [pnpm](https://pnpm.io/) and will work our way through our list of these years projects having received the highest number of votes.
