...
gen_enforced_field(WorkspaceCwd, 'repository.type', 'git') :-
  \+ workspace_field(WorkspaceCwd, 'private', true).
gen_enforced_field(WorkspaceCwd, 'repository.url', 'https://github.com/tdeekens/tdeekens.name.git') :-

@emmenko emmenko on 5 Nov Contributor
Use the correct repo url here
