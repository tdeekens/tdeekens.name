      ...
      <main className="mx-16 my-8 font-mono xl:text-sm max-w-6xl">
        ...
        <section className="flex flex-col justify-center align-middle">
          ...
          <article className="py-4">
            <Text.Paragraph>
              Retired basketball player, lousy guitarist but also developer,
              avid teacher and <strong>spontaneous speaker</strong> with a
              strong experience in{' '}
              <strong>frontend development and architecture</strong>. Feels{' '}
              <strong>great joy in mentoring</strong> while working with diverse
              teams in agile environments. Likes{' '}
              ...
              Over time broadened <strong>knowledge of the tech stack</strong>{' '}
              by gaining practical experience in building robust and well tested
              frontends while also{' '}
              <strong>working on associated RESTful and GraphQL APIs</strong>.
              Additionally, knowledgeable in{' '}
              <strong>continuous integration and deployment strategies</strong>{' '}
              with backing infrastructure such as Prometheus, Kubernetes, Kibana
              and Grafana.
              <br />
        ...
        <section>
          ...
          <article className="py-4">
            ...
            />
            <Text.Paragraph>
              Transitioned into being a <strong>fully remote Tech Lead</strong>{' '}
              for all frontend related topics for{' '}
              ...
              collaboratively with engineers and product managers while then
              guiding and communicating their realisation.
            </Text.Paragraph>
            <Text.Paragraph>
              During my time at commercetools the engineering team grew from ten
              to about 70 engineers while the company now has about 360
              employees. The product, an headless e-commerce API, managed to
              attract more than 200 customers. Such as large enterprises from
              Lego, Volkswagen, Yamaha, AT&T, Bang & Olufsen, Quantas and
              Universal. In the process commercetools went through various
              rounds of funding and a 1.9B dollar evaluation.
            </Text.Paragraph>
          ...
          <article className="py-4">
            ...
            <Text.Paragraph>
              ...
              <strong>internationalised</strong>, customisable web application
              for <strong>e-commerce</strong> merchants allowing administration
              of complex and large scale product, category, order, discount and
              customer data.
            </Text.Paragraph>
            <Text.Paragraph>
              Working on the frontend and nearby REST & GraphQL APIs of the
              Merchant Center built with{' '}
              <ExternalLink href="https://facebook.github.io/react/">
                React
              </ExternalLink>
              ,{' '}
              <ExternalLink href="https://apollographql.com">
                Apollo
              </ExternalLink>{' '}
              and{' '}
              ...
              . The application follows a sub application architecture allowing
              easy extensions and parallel development and deployments by
              multiple teams in a <b>test-driven and pull request</b> based
              development environment on GitHub. Continuous Integration is
              performed via{' '}
              <ExternalLink href="https://circleci.com">CircleCI</ExternalLink>{' '}
              with development branches being automatically pushed to a{' '}
              <ExternalLink href="kubernetes.io/">Kubernetes</ExternalLink>{' '}
              cluster. Additionally supporting the Node.js and JavaScript SDK
              team.
            </Text.Paragraph>
          ...
          <article className="py-4">
            ...
            />
            <Text.Paragraph>
              Working as a JavaScript developer within a agile team building
              great <strong>web-based software</strong> for comprehensive{' '}
              <strong>social network data monitoring</strong> and analysis.
            </Text.Paragraph>
            <Text.Paragraph>
              Working on frontend and related backends powering browser based
              data visualisations of social media data from various sources.
              Activities include the implementation of performant and reusable{' '}
              <strong>visualisation components</strong> using Backbone.js as
              well as maintaining a large, highly interactive and customisable
              dashboard UI. All with a focus on{' '}
              <strong>Continuous Integration</strong> and Continuous Delivery in
              a <strong>test-driven and pull request</strong> based development
              environment using GitHub and TravisCI.
            </Text.Paragraph>
          ...
          <article className="py-4">
            ...
            <Text.Paragraph>
              Duties include architecting and implementing the next version of
              the E-POST Portal which has been successfully launched. An
              application built of multiple separate frontends, interacting with
              several backend services. Furthermore, helped simplifying and
              rebuilding registration processes while being heavily engaged in
              UX discussions. A heavy focus on developer experience lead to
              building multiple mostly open sourced build-tasks while also
              maintaining modern development stacks across projects.
            </Text.Paragraph>
          ...
          <article className="py-2">
            ...
            <Text.Paragraph>
              ...
              <strong>organisational structure</strong> in regards to
              communication flow and blockages relating to the empowerment of
              cross-functional teams. A full version be found on{' '}
          ...
          <article className="py-2 print-hidden">
            ...
            <Text.Paragraph>
              ...
              . Also engaged in daily development working with{' '}
          ...
          <article className="py-2 print-hidden">
            ...
            />
            <Text.Paragraph>
              Continuation of work after finishing bachelor’s thesis. Evolving
              the previously designed prototype{' '}
              <strong>developing a data administration application</strong>.
              Gaining more experience with modern web development using{' '}
              <strong>HTML5/CSS3</strong>, <strong>JavaScript</strong> and
              related frameworks such asBackbone.js, martionette.js and jQuery.
              Also partly worked on daily development of other products.
            </Text.Paragraph>
          </article>
          ...
          <article className="py-2">
            ...
            />
            <Text.Paragraph>
              Combined experience in working at zweitwerk while performing
              research and writing on a <strong>bachelor’s thesis</strong>. The
              thesis entailed a systematic comparison of <strong>NoSQL</strong>{' '}
              (BigTable, Dynamo and MongoDB) and <strong>SQL</strong> (MySQL and
              Oracle) databases while performing benchmarks and developing a
              backend angostic <strong>proof-of-concept prototype</strong> of a
              product database for their media asset management system.
            </Text.Paragraph>
          </article>
          ...
          <article className="py-2 print-hidden">
            ...
            <Text.Paragraph>
              ...
              (Zend backed). The application’s features included video
              conferences between care service and a retiree and administration
              of clinical records. My duties included implementation and{' '}
              <strong>testing of a PHP-based backend</strong> as well as working
              on every part of the frontend. c
            </Text.Paragraph>
          </article>
        </section>
        ...
        <section>
          ...
          <article className="py-2">
            ...
            <Text.Paragraph>
              A Express middleware (or Hapi plugin) to easily export request
              timing metrics from an Express/Hapi application to Prometheus. The
              library contains few but powerful abilities to configure e.g.
              labels or to perform normalisation on measured values.
            </Text.Paragraph>
          </article>
          <article className="py-2">
            <Text.Headline as="h3">
            ...
            <Text.Paragraph>
              ...
              lerna) offering Higher Order Components (HoCs) and other utilities
              to enable easy feature toggling of React components (supporting
              single- and multivariate flags). A version for Redux (via a store
              enhancer) integrates nicely with the Redux DevTools. Another
              standalone React version using a broadcasting mechanism allows
              integrating the library within any React application.
            </Text.Paragraph>
          </article>
          <article className="py-2">
            <Text.Headline as="h3">
              ...
              - A DOM-only, super-fast, tolerant XSS sanitiser for HTML, MathML
              and SVG
            </Text.Headline>
            <Text.Paragraph>
              Contributor for DOMPurify which is written in JavaScript and works
              in all modern browsers (Safari, Opera (15+), Internet Explorer
              (10+), Spartan, Firefox and Chrome - as well as almost anything
              else using Blink or WebKit). It doesn&apos;t break on IE6 or other
              legacy browsers. It simply does nothing there. Helping to ensure
              code quality for setting up and maintaining continuous integration
              via TravisCI and BrowserStack in 8 different browsers.
            </Text.Paragraph>
          </article>
          <article className="py-2 print-hidden">
            <Text.Headline as="h3">
            ...
            <Text.Paragraph>
              A pet project with the domain model of a conference and its
              attendees, speakers and organisers. Build with a NodeJs service
              for each entity and with a GraphQL (Apollo Stack) server in front.
              Technologies included in this project is: GraphQL, HapiJs, Ava
              (testing), XO (linting), nodemon, Docker and PM2.
            </Text.Paragraph>
          </article>
          <article className="py-2 print-hidden">
            <Text.Headline as="h3">
          ...
          <article className="py-2 print-hidden">
            ...
            <Text.Paragraph>
              ...
              iterator factory with a given concurrency. It returns a Promise
              which resolves to an Array whenever all tasks have ben run. The
              order of items is maintained - same as in the list of factory
              functions passed. It is built using webpack as a UMD module and
              runs on Node.js or in the browser as CommonJS, AMD, ESM or as a
              global.
            </Text.Paragraph>
          </article>
          <article className="py-2 print-hidden">
            <Text.Headline as="h3">
              ...
              - A set of tools generating manifests with fingerprinted assets to
              be injected and cached
            </Text.Headline>
            <Text.Paragraph>
              Every unit of an application can create a{' '}
              <strong>custom manifest</strong> listing all assets it consists
              of. These <strong>assets will be injected</strong> into the page
              while their contents will be cached when they are once loaded.
              After the <strong>cache (local storage)</strong> is filled it
              serves all files on any subsequent page load to speed up the
              initial load time. The{' '}
              <strong>caches might be invalidated</strong> at runtime by making
              a comparison between old and eventually new manifest(s).
            </Text.Paragraph>
          </article>
        </section>
        ...
        <section>
          ...
          <section className="sm:block md:flex flex-row items-stretch text-md">
              ...
              <List.Unordered>
                ...
                <List.Item>
                  <ExternalLink href="https://techblog.commercetools.com/render-props-apollo-and-formik-build-and-compose-forms-in-react-with-ease-f79a594be239">
                    👩🏻‍🍳 Render Props, Apollo and Formik: build and compose forms
                    in React with ease 🏄🏾‍
                  </ExternalLink>
                </List.Item>
                <List.Item>
                ...
                <List.Item>
                  <ExternalLink href="https://techblog.commercetools.com/embracing-real-time-feature-toggling-in-your-react-application-a5e6052716a9">
                    Embracing real-time feature toggling in your React
                    application
                  </ExternalLink>
                </List.Item>
                <List.Item>
            ...
            <article className="sm:my-4 flex-grow flex-1 pr-8">
              ...
              <List.Unordered>
                <List.Item>
                  Shortcut to Tech Leadership: Accelerate Your Journey From
                  Maker to Multiplier{' '}
                ...
                <List.Item>
                  ...
                  <span className="italic">(edX)</span>
                </List.Item>
              </List.Unordered>
        ...
        <section className="print-hidden">
          ...
          <article className="py-2">
            ...
            <Text.Paragraph>
              Been actively engaged in teams and clubs since the age of nine
              playing in many cities and countries. Helping clubs, taking over
              coaching at times and just enjoying being around a team while
              playing at a high level. Recently been focussing more on guitar
              than basketball.
            </Text.Paragraph>
          </article>
          <article className="py-2">
            ...
            <Text.Paragraph>
              Picked up the guitar as an autodidact learning to play for four
              years now.
            </Text.Paragraph>
          </article>
        </section>
